	...
	<div class="head">
		<div class="wrapper">
			...
			<ul class="container-link">
				<li>
					<a class="link-1" onclick="openDropdown(1)">
						<span>Solutions</span>
						<img src="img/common/arrow-2.svg" alt="">
					</a>
				</li>
				<li>
					<a class="link-2" onclick="openDropdown(2)">
				...
				<li>
					<a class="link-3" onclick="openDropdown(3)">
			...
			<div class="container-action">
				...
				<a class="demo" href="https://admin.snapcall.io/register">
		...
		<div class="wrapper">
			<ul>
				<li>
					<a href="">
						<div class="icn">
							<img src="img/header/link-icn/icn-1.svg" alt="">
						</div>
						<div class="text">
							<h4>
				...
				<li>
					<a href="">
						<div class="icn">
							<img src="img/header/link-icn/icn-2.svg" alt="">
						</div>
						<div class="text">
							<h4>
								Commercialisateur
		...
		<div class="wrapper">
			<ul>
				<li>
					<a href="">
						<div class="icn">
							<img src="img/header/link-icn/icn-10.svg" alt="">
						</div>
						<div class="text">
							<h4>
				...
				<li>
					<a href="">
						<div class="icn">
							<img src="img/header/link-icn/icn-4.svg" alt="">
						</div>
						<div class="text">
							<h4>
								Espace prescripteur 
				...
				<li>
					<a href="">
						<div class="icn">
							<img src="img/header/link-icn/icn-5.svg" alt="">
						</div>
						<div class="text">
							<h4>
								Digitalisation de la vente immobilière 
							</h4>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.
							</p>
				...
				<li>
					<a href="">
						<div class="icn">
							<img src="img/header/link-icn/icn-6.svg" alt="">
						</div>
						<div class="text">
							<h4>
								Suivi des ventes immobilières 
							</h4>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.
							</p>
				...
				<li>
					<a href="">
						<div class="icn">
							<img src="img/header/link-icn/icn-7.svg" alt="">
						</div>
						<div class="text">
							<h4>
				...
				<li>
					<a href="">
						<div class="icn">
							<img src="img/header/link-icn/icn-8.svg" alt="">
						</div>
						<div class="text">
							<h4>
		...
		<div class="wrapper">
			<ul>
				<li>
					<a href="">
						<div class="icn">
							<img src="img/header/link-icn/icn-9.svg" alt="">
						</div>
						<div class="text">
							<h4>
								Notre histoire 
