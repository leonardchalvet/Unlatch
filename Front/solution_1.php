			...
			<section id="section-cover" class="sectionAnim_container">
				<div class="wrapper">
					...
					<div class="container-img elAnim__slide anim__delayMedium_7">
						<img src="img/common-solutions/section-cover/cover-solution-1.jpg" alt="">
					</div>
				</div>
			</section>
					...
					<div class="container-features">
						...
						<div class="feature higlight sectionAnim_container">
							...
							<div class="container-background">
								<img class="obj-1 elAnim__slide anim__delayMedium_4" src="img/common-solutions/section-features/obj-1.svg" alt="">
								<img class="obj-2 elAnim__slide anim__delayMedium_5" src="img/common-solutions/section-features/obj-2.svg" alt="">
							</div>
						</div>
						<div class="feature sectionAnim_container">
							<div class="container-illu elAnim__sk">
				...
				<div class="wrapper">
					...
					<div class="container-text">
						...
						<div class="container-infos elAnim__slide anim__delayMedium_4">
							<p>Amélie Huruguen, Directrice Commerciale chez Unlatch</p>
						</div>
					</div>
				</div>
			</section>
